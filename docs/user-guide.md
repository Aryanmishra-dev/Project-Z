# PDF Quiz Generator - User Guide

Welcome to the PDF Quiz Generator! This guide will help you get started with creating quizzes from your PDF documents.
...
1. Click **Upload PDF** on the dashboard or navigate to **My PDFs**
2. Either:
   - Click the upload area and select a file, or
...
- **Failed**: An error occurred (click for details)

### Managing PDFs

- **View**: Click a PDF to see its details and generated questions
- **Delete**: Click the trash icon to remove a PDF
- **Refresh Questions**: Click the refresh icon to regenerate questions
...
1. Go to **My PDFs** and select a document
2. Click **Start Quiz** button
3. Configure your quiz:
   - **Number of Questions**: Choose 5, 10, 15, or 20
   - **Difficulty**: Easy, Medium, or Hard
   - **Time Limit**: None, 30 sec, 1 min, or 2 min per question
4. Click **Begin Quiz**
...
1. Answer all questions (unanswered questions count as wrong)
...
- **Question Review**: Each question with your answer and the correct answer
- **Explanations**: AI-generated explanations for each answer
...
- **Download My Data**: Export all your information
