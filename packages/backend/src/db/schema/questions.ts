 ...
 */
import { pgTable, uuid, text, integer, timestamp, pgEnum, jsonb, decimal, index } from 'drizzle-orm/pg-core';
...
export const questions = pgTable('questions', {
  ...
  pdfId: uuid('pdf_id').references(() => pdfs.id, { onDelete: 'cascade' }).notNull(),
  ...
  validQualityIdx: index('idx_questions_valid_quality').on(table.validationStatus, table.qualityScore),
}));
